/*
powerfullz 的 Substore 订阅转换脚本（添加 BackHome 策略）
...
const baseRules = [
    `IP-CIDR,192.168.50.0/24,${PROXY_GROUPS.BACK_HOME},no-resolve`,
...
function buildProxyGroups({
    ...
    const hasHomeSS = allProxies && allProxies.some(p => p.name === "HomeSS");
